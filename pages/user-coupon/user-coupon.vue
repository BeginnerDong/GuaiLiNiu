<template>
	<view>
		...
		<view class="p-r z10 bg-white p-s top-0 shadowM">
			<view class="flex nav">
				<view class="li" :class="navCurr==0?'on':''" @click="changeNav(0)">未使用</view>
				<view class="li" :class="navCurr==1?'on':''" @click="changeNav(1)">已使用</view>
				<view class="li" :class="navCurr==2?'on':''" @click="changeNav(2)">已过期</view>
			</view>
		</view>
		
		<view>
			<view class="mt-3 colorf p-r" v-show="navCurr==0">
